...
namespace Hannet.WebApi.Infrastructure.Extentsions
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            services
               .AddDbContext<HannetDbContext>(options => options
        ...
        public static void MigrationDb(this IApplicationBuilder app)
        {
            ...
            {
                var context = serviceScope.ServiceProvider.GetRequiredService<HannetDbContext>();
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services)
            => services.AddSwaggerGen(s =>
            {
                s.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    {
                        Name = "Lê Ngọc Huy",
                        Email = "huyln@astec.vn",
                        Url = new Uri("https://www.facebook.com/profile.php?id=100087136629630")
                    }
                });
